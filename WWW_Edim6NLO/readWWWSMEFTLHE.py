...
if __name__ == '__main__':
    ...
    mu_lv = rt.TLorentzVector()
    nuel_lv = rt.TLorentzVector()
    numu_lv = rt.TLorentzVector()
    ...
    for oneEvent in eventsReadIn:
        ...
        for i in range(0,len(myLHEevent.Particles)):
            ...
            if(abs(p['ID']) == 11): el_lv = rt.TLorentzVector(p['Px'], p['Py'], p['Pz'], p['E'])
            if(abs(p['ID']) == 13): mu_lv = rt.TLorentzVector(p['Px'], p['Py'], p['Pz'], p['E'])
            if(abs(p['ID']) == 12): nuel_lv = rt.TLorentzVector(p['Px'], p['Py'], p['Pz'], p['E'])
            if(abs(p['ID']) == 14): numu_lv = rt.TLorentzVector(p['Px'], p['Py'], p['Pz'], p['E'])
            if ((abs(p['ID']) == 1 or abs(p['ID']) == 2 or abs(p['ID']) == 3 or abs(p['ID']) == 4)):
              ...
              #M_www.Fill((mu_lv+numu_lv).M())
              #if n_q==4: M_www.Fill((q1_lv+q2_lv).M())
              if n_q==4: M_www.Fill((el_lv+nuel_lv+mu_lv+numu_lv+q1_lv+q2_lv).M()) 
